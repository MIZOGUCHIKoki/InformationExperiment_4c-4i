...
\begin{frame}[t]{\ftitle}
    リソースを効率よく運用できる．\hfill\cite{2015amazon}
    \begin{figure}
        \centering
        \begin{minipage}[b]{.48\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \coordinate (C) at (3,3);
                \coordinate (D) at (4,2);
                \draw[red,thick, name path=curve, save path=\curve]plot[smooth, tension=0.7]coordinates {(O)(A)(B)(C)(D)};
...
\begin{frame}[t]{\ftitle}
    ...
    \begin{table}
        ...
        \begin{tabularx}{\textwidth}{cRRR}
                             & \multicolumn{1}{c}{共用サーバ} & \multicolumn{1}{c}{専用サーバ} & \multicolumn{1}{c}{仮想専用サーバ}          \\
            \hline
