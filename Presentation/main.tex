...
\usepackage{luatexja}
\usepackage{hyperref,listings,tabularx,tikz,pifont,fontawesome}
\usepackage[symbol]{footmisc}
\usetikzlibrary{arrows.meta,positioning,calc,fit,shapes.geometric,intersections,backgrounds}
...
\renewcommand{\insertreturnsymbol}{\faSmileO\faArrowRight\space}
\hypersetup{
    colorlinks=true,
    linkcolor=black,
    urlcolor=blue
...
\setbeamertemplate{section in toc}{
    {\color{structure}\inserttocsectionnumber.}\ \inserttocsection\vspace{.2em}
}

\setbeamertemplate{subsection in toc}{
    \hspace{1.2em}{\color{structure}\rule[.3ex]{3pt}{3pt}}\ \inserttocsubsection\par\vspace{.2em}
}
