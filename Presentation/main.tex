...
\newcommand{\tocc}{
    \begin{frame}[t]{\thesection.\ \secname}
        ...
        %         \tableofcontents[sections={1},currentsection,sectionstyle=show/shaded,subsectionstyle=show/show/shaded]
        %     \end{column}
        %     \begin{column}{.48\textwidth}
        %         \tableofcontents[sections={2},currentsection,sectionstyle=show/shaded,subsectionstyle=show/show/shaded]
        %     \end{column}
        % \end{columns}
