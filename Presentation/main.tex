    ...
    \begin{frame}[t]{\thesection.\ \secname}
        \begin{columns}[t]
            \begin{column}{.48\textwidth}
                \tableofcontents[sections={1-4},currentsection,sectionstyle=show/shaded,subsectionstyle=show/show/shaded]
            \end{column}
            \begin{column}{.48\textwidth}
                \tableofcontents[sections={5},currentsection,sectionstyle=show/shaded,subsectionstyle=show/show/shaded]
            \end{column}
        \end{columns}
    \end{frame}
}
