...
\usepackage{luatexja}
\usepackage{hyperref,listings,tabularx,tikz}
...
\lstdefinelanguage{docker-compose-2}{
    ...
    morekeywords={FROM,RUN,CMD,EXPOSE},
    ...
    \begin{frame}[t]{\thesection.\ \secname}
        \begin{columns}[t]
            \begin{column}{.48\textwidth}
                \tableofcontents[sections={1-3},currentsection,sectionstyle=show/shaded,subsectionstyle=show/show/shaded]
            \end{column}
            \begin{column}{.48\textwidth}
                \tableofcontents[sections={4},currentsection,sectionstyle=show/shaded,subsectionstyle=show/show/shaded]
            \end{column}
        \end{columns}
    \end{frame}
}
