...
この技術は，VLAN IDを各セグメントに定義し，EthernetヘッダにVLAN IDを付加することで，
\begin{figure}
    \centering
    \begin{minipage}[b]{.55\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \node[below]at(sg1.south){セグメントA};
            \node[below]at(sg2.south){セグメントB};
    ...
    \begin{minipage}[b]{.43\textwidth}
        ...
        \begin{tikzpicture}
            ...
            \node[port=magenta,right=.5cm of p12](p13){};
            ...
            \node[port=magenta,right=.5cm of p22](p23){};
            ...
            \begin{scope}[on background layer]
                \node[fit={(lp11)(lp12)(lp21)(lp22)},draw,rounded corners,fill=cyan!10,draw=cyan!70!black,](sg1){};
                \node[fit={(lp13)(lp14)(lp23)(lp24)(p15)($(p25)+(.37cm,0)$)},draw,rounded corners,fill=magenta!10,draw=magenta!70!black](sg2){};
            \end{scope}
            \node[below,align=center]at(sg1.south){\tiny セグメントB\\\tiny VLAN ID:10};
            \node[below,align=center]at(sg2.south){\tiny セグメントA\\\tiny VLAN ID:11};
        \end{tikzpicture}
